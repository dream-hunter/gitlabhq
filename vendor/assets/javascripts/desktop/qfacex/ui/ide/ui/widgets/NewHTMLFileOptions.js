...
],function(declare, _Templated, _Widget, WorkbenchPart, Preferences, 
			Menu, MenuItem, Path, ToolTip, DropDownButton, uiNLS, commonNLS, templateString,
			Button, ThemeSelection, Theme
			){
	return declare( [_Widget,_Templated,WorkbenchPart], {
		...
		postCreate : function(){
			...
			var lastDialogValues = this._workbench.workbenchStateCustomPropGet('nhfo');
