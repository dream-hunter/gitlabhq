define( [
...
], function(CommandStack, doLater, declare, Action, mTextStyler, mEditor, mEditorFeatures, mHtmlGrammar, mTextMateStyler, mTextView, mTextModel, mContentAssist, mJSContentAssist, mCSSContentAssist) {
	var _EditorCutAction = declare( Action, {
	...
	var _EditorCopyAction = declare( Action, {
		constructor: function (editor) {
			this._editor=editor;
		},
		run: function(context){
	...
	var _EditorPasteAction = declare(Action, {
		constructor: function (editor) {
			this._editor=editor;
		},
		run: function(context){
...
//      	});
		...
		this.cutAction=new _EditorCutAction(this.editor);
		this.copyAction=new _EditorCopyAction(this.editor);
		this.pasteAction=new _EditorPasteAction(this.editor);
	},
