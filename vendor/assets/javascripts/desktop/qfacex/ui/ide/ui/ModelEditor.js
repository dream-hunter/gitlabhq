define("qfacex/ui/ide/ui/ModelEditor", [
	"dojo/_base/declare", 
	"./TextEditor"
], function(declare, TextEditor) {
...
return declare(TextEditor, {
	...
	handleChange: function(text) {
        ...
        this._workbench.publish("/davinci/ui/modelChanged", changeEvent);
	},
	...
	selectionChange: function (selection) {
		...
		if (childModel != this._selectedModel) {
			try {
				...
				this._workbench.publish("/davinci/ui/selectionChanged", [selection], this);
			} finally {
