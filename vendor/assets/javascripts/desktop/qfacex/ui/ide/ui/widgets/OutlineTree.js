define("qfacex/ui/ide/ui/widgets/OutlineTree", [
	"dojo/_base/declare",
	"dojo/_base/connect",
	"dojo/_base/array",
	"dojo/touch",
	...
	"dijit/Tree",
	"./_ToggleTreeNode",
], function(declare, connect, array, touch, mouse, Tree, ToggleTreeNode) {
...
return declare(Tree, {
	...
	_onDblClick: function(/*TreeNode*/ nodeWidget, /*Event*/ e) {
		...
		var c = this._workbench.getOpenEditor().getContext();
		if (c) {
