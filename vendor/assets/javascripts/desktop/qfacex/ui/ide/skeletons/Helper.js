...
define( function() {
	...
	Helper.prototype = {
		 ...
		 * 
		 * @param {qfacex/ui/ide/ve/DijitWidget} widget  the (Maqetta) widget instance
		 ...
		 * 
		 * @param  {qfacex/ui/ide/html/HTMLElement} srcElement
		 */
		 ...
		 * 
		 * @param  {qfacex/ui/ide/ve/_Widget} widget
...
//			}
		 ...
		 * 
		 * @param  {qfacex/ui/ide/ve/_Widget} widget  the widget instance
		 * @param  {boolean} attach if true attach widgets to this child node.
		 *             If true, function must "attach" child widget nodes by calling 
		 *             'require("qfacex/ui/ide/ve/widget").getWidget(node)'.
		 * 
		 * @return {qfacex/ui/ide/ve/_Widget[]}  array of child widgets
		 */
...
//					}
//					if (attach) {
//						children.push(require("qfacex/ui/ide/ve/widget").getWidget(node));
//					} else {
...
//			return data;
		 ...
		 * @see qfacex/util/GeomUtils#getMarginBoxPageCoords
		 */
...
//			return command;
		 ...
		 * 
		 * @param {object} args
		 * @param {qfacex/ui/ide/ve/_Widget} [args.parent]  target parent widget for initial creation
		 ...
		 * 
		 * @param  {qfacex/ui/ide/commands/CompoundCommand} command
		...
		/**
		 * [popup description]
		 * @param  {qfacex/ui/ide/ve/_Widget} widget [description]
		 */
		 ...
		 * @param  {qfacex/ui/ide/ve/_Widget} widget - Widget that is being reparentted
		 */
...
//				}
		 ...
		 * @param  {qfacex/ui/ide/ve/DijitWidget} widget [description]
		 */
