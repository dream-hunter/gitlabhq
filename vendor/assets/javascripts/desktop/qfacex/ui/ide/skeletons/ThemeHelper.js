...
define("qfacex/ui/ide/skeletons/ThemeHelper", function() {
	...
	return {
		 ...
		 * @param  {qfacex/ui/ide/ve/Context} context - the current document context
		 */
		 ...
		 * 
		 * @param  {qfacex/ui/ide/ve/Context} context - the current document context
		 * @param  {qfacex/ui/ide/Theme} theme - the current theme object
		 */
