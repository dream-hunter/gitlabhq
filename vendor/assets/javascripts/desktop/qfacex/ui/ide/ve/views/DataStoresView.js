...
return declare([ViewPart], {
    ...
    _createDSFromWidget: function(widget) {
        ...
        if (ds)
            this.publish("/davinci/data/datastoreAdded", widget.getAttribute('jsId'), ds, widget.type);
    },
    ...
    _showDataStores: function() {
        ...
        var dragSources = [{dragHandler: "qfacex/ui/ide/ve/palette/DataStoreDragSource",
        ...
        var popup = this._workbench.createPopup({ partID: 'davinci.ve.datastores',
    ...
    loadType: function(data) {
        ...
        if( !this._workbench.getOpenEditor().getContext().loadRequires(data.type,true)){
            return false;
        }
        var that = this;
    ...
    _createForm: function() {
        var context = this._workbench.getOpenEditor().getContext();
        ...
        var command = new AddCommand(form, context.getContainerNode(),context);
    ...
    _createTable: function() {
        ...
        var command = new AddCommand(table, context.getContainerNode(),context);
        context.getCommandStack().execute(command);
        return table;
    },
    ...
    _getSelectedDsId: function() {
        ...
        var selectedNode = workbench.getSelection();
