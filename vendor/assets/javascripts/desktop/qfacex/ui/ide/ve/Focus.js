...
function(require, declare, _WidgetBase, Mover, Moveable, Metadata, States, GeomUtils,WorkbenchPart) {
...
return declare( [_WidgetBase,WorkbenchPart], {
	...
	_updateFocusChrome: function(rect, offScreenAdjust){
		...
		var focusContainer = this._workbench.focusContainer;//dojo.byId('focusContainer');
	...
	onMouseDown: function(event){
		...
		if(!this._context._activeTool.isInstanceOf(require("qfacex/ui/ide/ve/tools/SelectTool"))){
			return;
		}
		...
		//document.getElementById("davinci-help-dropdown").focus();//TODO : TO be modified
    ...
    _createSubwidgetList: function() {
        ...
        if(subwidgets){
            ...
            this._connections = [];
            this._connections.push(this._workbench.subscribe("/davinci/ui/subwidgetSelectionChanged",dojo.hitch(this,this._subwidgetSelectedChange)));
            this._connections.push(this._workbench.subscribe("/davinci/states/state/changed", dojo.hitch(this, this._updateSubwidgetListForState)));
        }else{
    ...
    _subwidgetSelected: function(id, e){
        ...
        this._workbench.publish("/davinci/ui/subwidgetSelectionChanged",{subwidget: subwidget, origin: this.declaredClass});
    ...
    _updateSubwidgetListForState: function() {
    	if (this._context.editor != this._workbench.currentEditor){
            // not for us
            return;
        }
        if (this._context._selectedWidget && this._displayedWidget === this._context._selectedWidget) {
            var editor = this._workbench.currentEditor,
