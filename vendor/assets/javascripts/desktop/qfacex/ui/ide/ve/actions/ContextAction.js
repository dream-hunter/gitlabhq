...
return declare([Action], {
	...
	_getEditor: function() {
		return this._workbench.currentEditor;// top.davinci && top.davinci.Runtime && top.davinci.Runtime.currentEditor;
	},
	...
	fixupContext: function(contextFromWorkbench){
		...
		if(obj.isInstanceOf(require("qfacex/ui/ide/ve/Context"))){
			return obj;
