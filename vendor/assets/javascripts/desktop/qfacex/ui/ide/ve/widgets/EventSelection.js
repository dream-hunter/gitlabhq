define( ["dojo/_base/declare",
        ...
        "qfacex/ui/ide/ve/commands/EventCommand"
        
],function(declare, connect, ViewLite, HTMLStringUtil, States, ModifyCommand,EventCommand){
...
var EventSelection = declare([ViewLite], {
		...
		buildRendering : function(){
			...
			var template="<div>";
			template+= HTMLStringUtil.generateTable(this.pageTemplate, {zeroSpaceForIncrDecr:true});
			template+= "</div>";
		...
		startup : function(){
			...
			this.subscribe("/davinci/ui/context/loaded",  this._buildSelectionValues);
			this.subscribe("/davinci/states/stored",  this._buildSelectionValues);
			this.subscribe("/davinci/states/state/added",  this._buildSelectionValues);
			this.subscribe("/davinci/states/state/removed", this._updateValues);
			this.subscribe("/davinci/states/state/renamed",  this._updateValues);
		...
		onEditorSelected : function(){
		 ...
		 _onChange : function(a){
			...
			var command = new EventCommand(this._widget, properties,context);
			this.publish("/davinci/ui/widgetPropertiesChanges",{source:this._editor.editor_id, command:command});
