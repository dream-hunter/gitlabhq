...
], function(declare, _Widget,HtmlModel) {
...
//		}
		...
		try{
			...
			console.debug("Error in ve/helpers/loadHtmlWidget.buildRendering: "+e);
		}
	},
    ...
    _getChildrenData: function(options) {
        ...
        // ve/widget.createWidget(), which can take child data either
        ...
        dojo.forEach(domNode.childNodes, function(node) {
            ...
            case 1: // Element
                var w = require("qfacex/ui/ide/ve/widget").byNode(node);
                if (w) {
                    d = w.getData(options);
                }
                break;
