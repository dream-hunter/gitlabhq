...
*/
	...
	isThemeEditor: function() {
		return false ;//this._editor && this._editor.declaredClass === 'davinci.ve.themeEditor.ThemeEditor';
	},
...
//FIXME: Seems to be only used by theme editor
	...
	_hideShowToolBar: function(){
		...
		var showAppStates = (this._editor.isInstanceOf(require("qfacex/ui/ide/ve/PageEditor")));
