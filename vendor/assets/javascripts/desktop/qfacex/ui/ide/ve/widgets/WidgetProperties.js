define([
	...
	return declare([ViewLite], {
		templateString : "<div class='propGroup'></div>",
		...
		buildRendering: function(){
			//this.domNode = this.propDom = dojo.doc.createElement("div");  //modified by LWF 
			//dojo.addClass(this.domNode, "propGroup");
			this.inherited(arguments);
			dojo.attr(this.domNode, "propGroup", this.key);
			this._connects = [];
			this.propDom = this.domNode;
		},
		...
		onWidgetSelectionChange: function() {
			...
			var metadata = Metadata.query(this._widget);
