define( ["dojo/_base/declare",
	...
	return declare( [ViewLite], {
		...
		buildRendering: function(){
			...
			this.templateString = "<div>"+template+"</div>";

			this.inherited(arguments);
			this.subscribe("/davinci/ui/widgetValuesChanged", dojo.hitch(this, this.onWidgetSelectionChange));
			this.subscribe("/davinci/ui/widget/replaced", dojo.hitch(this, this._widgetReplaced));
		},
