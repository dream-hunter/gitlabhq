define([
    ...
    "dojo/_base/declare",
    "dojo/_base/connect",
    "qfacex/ui/ide/maqetta/AppStates",
    "qfacex/ui/ide/ve/commands/EventCommand",
    "qfacex/ui/ide/ve/commands/StyleCommand",
	"qfacex/util/StyleArray"
], function(require,declare, connect, maqettaStates, EventCommand, StyleCommand, StyleArray){
...
var veStates = declare(maqettaStates, {
	...
	_update: function(node, statesArray) {
		if(!Workbench.currentEditor || !Workbench.currentEditor.isInstanceOf(require("qfacex/ui/ide/ve/PageEditor"))){
			return;
		}
...
//FIXME: What's this doing? Why this particular set of events?
		...
		if (context) {
			var command = new EventCommand(widget, properties,context);
	...
	initialize: function() {
		...
		if (!this.subscribed) {
			...
			connect.subscribe("/davinci/states/state/renamed", dojo.hitch(this, function(e) { 
				var editor = this.getEditor();
				if (!editor) return; // ignore updates in theme editor
				var widget = (e.node && e.node._dvWidget);
