define([
	"qface/utils/markup/html/HTMLElement", //HTMLElement
	"qfacex/ui/ide/ve/metadata",
	"dojo/Deferred",
	"qfacex/ui/ide/ve/DijitWidget",
	"qfacex/ui/ide/ve/GenericWidget",
	"qfacex/ui/ide/ve/HTMLWidget",
	"qfacex/ui/ide/ve/ObjectWidget",
	"dojo/window"
], function(HTMLElement,metadata,Deferred,DijitWidget,GenericWidget,HTMLWidget,ObjectWidget) {
	...
	*/
	...
	byId: function(id, doc,context) {
		...
		if (context) { //	var context = davinci.Runtime.currentEditor.currentEditor.context;
