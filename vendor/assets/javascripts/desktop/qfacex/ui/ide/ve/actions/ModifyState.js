...
var ModifyStateWidget = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin,WorkbenchPart], {
	...
	onOk: function(e) {
		...
		if(workbench.currentEditor && workbench.currentEditor.currentEditor && workbench.currentEditor.currentEditor.context){
			editor = workbench.currentEditor;
...
return declare( [Action], {
	...
	run: function(){
		...
		var w = new davinci.ve.actions.ModifyStateWidget({workbench:this._workbench);
		var dialog = this._workbench.showModal(w, veNls.modifyState);
