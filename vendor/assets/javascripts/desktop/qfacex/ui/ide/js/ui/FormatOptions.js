define( [
	"dojo/_base/declare",
	"qface/utils/script/js/JSFile",
	"qface/utils/script/js/Format",
	"dijit/layout/ContentPane",
	"dijit/_TemplatedMixin",
	"qfacex/ui/ide/workbench/Preferences",
	"dojo/i18n!../nls/js"
], function(declare, JSFile, Format, ContentPane, TemplatedMixin, Preferences, jsNls) {
 
return declare( [ContentPane, TemplatedMixin], {
	templateString: "<div><div dojoAttachPoint='dynamicPanels' id=\"dynamicPanels\"></div></div>",

	// NOTE: The goal of #1638 was to remove all dependencies on qfacex/ui/ide/ui/Panel. To achieve that goal here, we 
	// merged the now defunct qfacex/ui/ide/workbench/PanelPreferencePane module with FormatOptions. In addition, we commented
