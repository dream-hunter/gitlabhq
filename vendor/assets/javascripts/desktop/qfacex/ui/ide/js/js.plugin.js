define("qfacex/ui/ide/js/js.plugin", [
	'require'
//	'../Workbench'
], function(require) {
...
return {
	...
	"davinci.editor": {
		...
		isDefault: true,
		//TODO implement		 icon : "",
		editorClass: "qfacex/ui/ide/js/ui/JavaScriptEditor",
		                  ...
		                  menu:[
		                     {
		                      ...
		                      },
		                      {
		                          ...
		                          run: function() {
		                              require("qfacex/ui/ide/ui/Resource").saveAs(thiw._workbench,'html');
		                          },
		                          isEnabled: function(context) {
		                              return this._workbench.getOpenEditor();
		                          },
...
/* XXX not working
				{
					...
					run: function() {
						var editor = require('qfacex/ui/ide/Workbench').getOpenEditor();
						if (editor) {
...
/*		{
		...
		},
		{
			...
			pane: "qfacex/ui/ide/js/ui/FormatOptions",
			defaultValues: {
				blockNewLine: false,
				blockIndent: 3,
