define( [
    	...
    	"qfacex/ui/ide/ui/SaveAsWidgetForm",
...
//  widget, or allow to add new ones.
    ...
    run: function(context) {
		var ContextClass = require("qfacex/ui/ide/ve/Context");
        if (context && context.isInstanceOf && ContextClass && context.isInstanceOf(ContextClass)) {
            if (typeof context.getContext === "function") {
                context = context.getContext();
            } else {
                context = this._workbench.getOpenEditor().getContext();
            }
        }
