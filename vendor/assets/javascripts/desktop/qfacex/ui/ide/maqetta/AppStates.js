...
States.prototype = {
	 ...
	 *     params.silent {boolean}  If true, don't broadcast the state change via /qfacex/ui/ide/states/state/changed
	 ...
	 *                             This feature is primarily used by design-time tools.
	 * Subscribe using states.subscribe("/maqetta/appstates/state/changed", callback).
...
//FIXME: Need to generalize this for nested states
	 ...
	 * Subscribe using states.subscribe("/davinci/states/state/added", callback).
	 */
	 ...
	 * Right now, node must by the BODY element.
	 * Subscribe using states.subscribe("/davinci/states/state/removed", callback).
	 */
