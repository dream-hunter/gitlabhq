define("qfacex/ui/ide/workbench/OutlineView", [
	"dojo/_base/declare",
	"qfacex/ui/workbench/ViewPart",
	"qfacex/ui/ide/ui/widgets/OutlineTree",
	"dijit/layout/ContentPane",
	"dojo/i18n!./nls/workbench"
], function(declare, ViewPart, OutlineTree, ContentPane, workbenchStrings){
...
//			this.currentEditor.removeChangeListener(this.modelStore);
	...
	createTree: function() {
		...
		this.subcontainer.className = "dvOutlineSubcontainer";
		...
		this.popup = this._workbench.createPopup({
	...
	selectionChanged: function(selection) {
		if (!this.publishing["/qfacex/ui/ide/ui/selectionChanged"] &&
