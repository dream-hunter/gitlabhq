...
define("maq-metadata-dojo/dojo/data/DataStoreBasedWidgetInput", [
	...
	"dojo/dom-class",
	"dijit/registry",
	"qfacex/ui/ide/ve/input/SmartInput",
	...
	"qfacex/ui/ide/ve/utils/URLRewrite",
	"dojox/form/DropDownSelect",	// used in template
	"qfacex/ui/ide/css!./templates/dojoStoreBasedWidgetInput.css",
], function(
	declare,
	lang,
	connect,
 ...
 *  board in all widgets, we'll need a more robust solution (that might likely involve parsing/modeling using classes in the qfacex/ui/ide/js package).
 */  
