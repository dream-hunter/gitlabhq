require({cache:{
'*now':function(r){r(['dojo/i18n!*preload*maq-metadata-clipart/clipart/nls/_DeviceClipartHelper*["ar","ca","cs","da","de","el","en-gb","en-us","es-es","fi-fi","fr-fr","he-il","hu","it-it","ja-jp","ko-kr","nl-nl","nb","pl","pt-br","pt-pt","ru","sk","sl","sv","th","tr","zh-tw","zh-cn","ROOT"]']);}
}});
define("maq-metadata-clipart/clipart/_DeviceClipartHelper", [
	"dojo/_base/declare",
	"dojo/_base/connect",
