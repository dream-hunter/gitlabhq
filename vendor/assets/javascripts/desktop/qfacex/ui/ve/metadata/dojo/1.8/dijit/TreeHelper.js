define("maq-metadata-dojo/dijit/TreeHelper", ["qfacex/ui/ide/ve/widget",
...
TreeHelper.prototype = {
	 ...
	 * @param {ve/_Widget} widget  Widget that is being deleted
	 * @return {commands/CompoundCommand}  command that is to be added to the command stack.
	 * 
