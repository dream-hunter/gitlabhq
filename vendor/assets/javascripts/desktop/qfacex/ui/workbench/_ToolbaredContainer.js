define([
    "dojo/_base/declare",
    "qfacex/widgets/LayoutWidgetLite"
], function(declare, LayoutWidgetLite){

return declare([LayoutWidgetLite], {
	...
	setContent: function(/*Widget*/data){
		...
		if(closeBoxNodes.length > 0){
			...
			dojo.connect(closeBox, 'click', this, function(event){
				this._workbench.collapsePaletteContainer(event.currentTarget);//modified by LWF 20130508
			});
		}
	 ...
	 * @param {string} editorClass  Class name for editor, such as "qfacex/ui/ide/ve/PageEditor"
	 */
	 ...
	 * @param {string} containerClass  Class name for view or editor, such as "qfacex/ui/ide/ve/PageEditor"
