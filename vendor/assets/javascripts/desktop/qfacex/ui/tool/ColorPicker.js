define([
 ...
 var ColorPicker = declare([_WidgetBase], {
		...
		postCreate: function(){
			...
			this._statics = ["", ColorPicker.divider, veNLS.colorPicker, veNLS.removeValue];
			this._run = {};
			if(!this.data ){
	...
	//FIXME: Remove code below and replace with call to ColorPickerFlat.show
