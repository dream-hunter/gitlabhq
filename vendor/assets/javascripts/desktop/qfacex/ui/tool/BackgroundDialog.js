define( ["dojo/_base/declare",
	...
	var getCSSForWorkspaceURL = function (baseLocation, relativeURLInside,workbench) {
		var workspaceUrl = workbench.getUserWorkspaceUrl(); // modified by LWF 20130428 TODO
	...
	var BackgroundDialog = declare( [WidgetLite,WorkbenchPart], {
		...
		postCreate: function(){
			...
			var bgProps = this._workbench._BackgroundWidgets; //modified by LWF 20130428 TODO
	
			//FIXME: Following code is mostly a copy/paste from ColorPicker.js
			//Should be refactored into a shared utility
			this._statics = ['', ColorPicker.divider, langObj.colorPicker, langObj.removeValue];
		...
		_onChangeColor: function(event, targetComboBox, actions){
			...
			if(action){
				...
				if(action == '_colorpicker'){
					var colorPickerFlat = new ColorPickerFlat({});
					...
					ColorPickerFlat.show(colorPickerFlat, initialValue, this, isLeftToRight);
				}
			}
