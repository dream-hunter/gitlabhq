...
], function(declare, LayoutWidget,_TemplatedMixin,_WidgetsInTemplateMixin) {

return declare([LayoutWidget,_TemplatedMixin,_WidgetsInTemplateMixin], {
	...
	buildRendering: function(){
		...
		if(/dojotype|data-dojo-type/i.test(this.domNode.innerHTML || "")){   //modified by LWF 20130426
