...
define([
    ...
    var Animation = declare( null, {
        ...
        _onAfterEnd: function(){
            ...
            if(this.node.id && qface.app.jaml.Animation.playing[this.node.id]===this.deferred){
                delete qface.app.jaml.Animation.playing[this.node.id];
            }
            this.onAfterEnd();
        },
    ...
    lang.mixin(Animation,{
	    slide : function(node, config){
	
	        //TODO create the return and set the startState, endState of the return
	        var ret = new Animation(config);
	        ret.node = node;
	  ...
	  //fade in/out animation effects
	    ...
	    roupedPlay : function(/*Array*/args){
	    ...
	    chainedPlay : function(/*Array*/args){
	        //args should be array of dojox.app.animation
