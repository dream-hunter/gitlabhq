...
define([
	"dojo/_base/kernel",
	"dojo/_base/lang",
	"qface/app/jaml/ref/sync",
	"qface/app/jaml/ref/_refBindingExtension"
], function(kernel, lang, sync){

	var ref = kernel.global.ref =  function(/*String*/ target, /*String*/ targetProp){
		// summary:
		...
		return { // qface/app/jaml/ref.handle
			atsignature: "qface.app.jaml.ref",
			target: target,
