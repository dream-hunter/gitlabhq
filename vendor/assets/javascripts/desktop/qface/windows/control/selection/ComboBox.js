define( [
	"qface/lang/declare",
	"qface/windows/meda/Visual",
	"qface/windows/meda/ContainerVisual",
	"qface/windows/controls/Control",
	"qface/windows/controls/ItemsControl",
],	function(declare,Visual,ContainerVisual, Control){

	var ComboBoxArrowVisual	= declare(Visual,{
		"-privates-"	: {
	...
	var ComboBoxVisual = declare(Control.ControlVisual,{
        paint : function(g){        
