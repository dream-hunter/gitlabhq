...
],function(declare,Statefu,_Layoutable) {
...
var DefViews = declare(null,{
	"-methods-"	:	{
		getView : function (d, obj){
...
var Tree = declare(ItemsControl,{
	...
	"-methods-"	:	{
        ...
        recalc_ : function (x,y,parent,root,isVis){
        ...
        getItemAtInBranch : function(root,x,y){
            if(root != null){
                var node = this.getIM(root);
        ...
        findOpened : function (item){
        	//指定されたアイテムの祖先のうち、オープン状態であり直近のアイテムを探す、
        ...
        isVerVisible : function (item){
        	//指定されたアイテムが可視かどうかをチェック
        ...
        nextVisibleInBranch : function (item){
        ...
        paintChild : function (g,root,index){
        ...
        itemInserted : function (target,item){
            this.stopEditing(false);
            this.vrp();
        },

        itemRemoved : function (target,item){
        ...
        itemModified : function (target,item){
            var node = this.getIM(item);
        ...
        stopEditing : function(applyData){
