define([
	...
	"qfacex/widgets/media/CubeVideo",
	"dojo/i18n!./nls/app"
   ...
   return declare([_App],{ 
        ...
        init: function(args)    {
            ...
            var self = this;
            topic.subscribe("/qface/system/desktop/scene/hide",function(scene){
            	if (self.scene == scene) {
            		self.player.pause();
            	}	
            });
            
            topic.subscribe("/qface/system/desktop/scene/show",function(scene){
            	if (self.scene == scene) {
            		self.player.play();
            	}	
            });
