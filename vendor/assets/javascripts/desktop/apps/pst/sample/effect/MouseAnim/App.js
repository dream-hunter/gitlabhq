define([
	 ...
	 "qface/windows/media/Matrix2D",
	 "qface/windows/media/EventDispatcher",
	 "qface/windows/media/DisplayObject",
	 "qface/windows/media/Container",
	 "qface/windows/media/Stage",
	 "qface/windows/media/MouseEvent",
	 "qface/windows/media/Shape",
	 "qface/windows/media/Ticker",
	 "qface/windows/media/Rectangle",
	 "qface/windows/media/BitmapAnimation",
	 "qface/windows/media/SpriteSheet",
