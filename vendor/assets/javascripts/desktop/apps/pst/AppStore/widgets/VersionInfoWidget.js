define([
  ...
  "dojo/_base/lang",
  "qface/Runtime"
  ],function(on,mouse,domClass,query,domConstruct,declare,array,WidgetBase,TemplatedMixin,Dialog,MultiSelect,Button,template,nlsAppStore,domStyle,baseFx,lang,
    qface){
